...
int main(int argc, char *argv[]){
  ...
  Real nor_op_factor = 1.0/3.0;
  Real shr_op_factor = 1.0/3.0;
  Real nor_str_factor = 10;
  Real shr_str_factor = 10;
  ...
  DataRegister::registerParameter("critical_normal_opening",crit_n_open*6/5);
  DataRegister::registerParameter("critical_shear_opening",crit_s_open*6/5);
