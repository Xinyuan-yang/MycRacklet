...
int main(int argc, char *argv[])
{
  ...
  UInt t = 0;
  UInt x_tip = 0;
  UInt x_lap = 0.05 * n_ele_ind;

  SpectralModel *model;

  model = new SpectralModel(n_ele_ind, nb_time_steps, dom_sizex,
                            nu, E, cs, tcut,
