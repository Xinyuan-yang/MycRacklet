/**
 * @file   mode_II_slip_weakening.cc
 * @author Fabian Barras <fabian.barras@epfl.ch>
 * @date   Mon Apr 30 18:47:26 2018
 *
 * @brief  Mode-II cract tip equation of motion
 *
 * @section LICENSE
 *
...
int main(int argc, char *argv[]){
  ...
  std::cout << "./mode_II_slip_weakening <output_folder_name> <nb_ele_x> <nb_time_steps>" << std::endl;
  ...
  std::string sim_name = "Mode-II crack tip equation of motion";

  std::cout << "./mode_II_rate_and_state " 
  ...
  sim_driver.launchCrack(dom_sizex/2.,1.75*G_length/2.,0.075,false);
