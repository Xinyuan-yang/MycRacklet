...
def main():
    ...
    sim_driver = cra.SimulationDriver(model)
    ...
    cra.DataRegister.registerParameterReal("res_normal_strength",max_n_str/10)
    cra.DataRegister.registerParameterReal("res_shear_strength",max_s_str/10)
